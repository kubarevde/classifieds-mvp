        ...
        <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_320px]">
          ...
          <aside className="space-y-3 rounded-xl border border-slate-200 bg-slate-50/80 p-4">
            ...
            <div className="rounded-lg border border-slate-200 bg-white p-2.5">
              <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">Запросы покупателей</p>
              ...
              <div className="mt-2 space-y-1.5">
                {matchingRequests.map((match) => (
                  ...
                  >
                    ...
                    <p className="text-[11px] text-slate-500">Match {match.matchScore} · {match.matchReasons[0]}</p>
                  </Link>
                ))}
              </div>
              <Link
